...
export default function EditPostForm({ post, locale, categories }: EditPostFormProps) {
  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = await updatePost(post.id, formData, content, locale);
    if (result?.error) {
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Editar publicación</h1>
            <p className="text-sm text-base-content/50 flex items-center gap-1.5 mt-0.5">
              <Globe className="w-3.5 h-3.5" />
              idealy.com.mx/{locale}/blog/{post.slug}
            </p>
          </div>
        </div>
        <Link
              ...
              <div className="px-5 pb-6 space-y-5 border-t border-base-300 pt-5">
                ...
                <div className="form-control">
                  ...
                  <textarea
                    ...
                    placeholder={post.summary || 'Descripción para buscadores...'}
                ...
                <div className="form-control">
                  ...
                  <p className="text-xs text-base-content/40 mt-1.5">
                    Solo si este contenido existe en otra URL. Evita contenido duplicado.
                  </p>
                </div>
              </div>
            )}
          ...
          <div className="card bg-base-100 shadow-sm border border-base-300 rounded-2xl p-6 space-y-5 sticky top-6">
            ...
            <div className="form-control">
              ...
              <div className="flex items-center gap-2">
                <select 
                  className="select select-bordered rounded-xl w-full text-sm font-semibold bg-base-200/50"
                  value={locale}
                  disabled
                >
              ...
              <p className="text-[10px] text-base-content/40 mt-1.5 px-1">
                El idioma está vinculado a la URL. Para cambiarlo, crea una nueva nota.
              </p>
            </div>
            ...
            <div className="form-control">
              ...
              <TagsInput initialTags={post.tags} name="tags" />
            </div>
            ...
            <p className="text-xs text-center text-base-content/25 font-mono">ID: {post.id.slice(0, 8)}...</p>
          </div>
        </div>
      </form>
    </div>
