  ...
  return (
    <div className="w-full">
      <main className="flex flex-wrap sm:w-full sm:flex-row">
        ...
        <div id="services" className='w-full flex py-5 p-10 justify-center items-center'>
        ...
        <div id="portfolio" className='w-full mb-10 '>
          <div className='w-3/4 m-auto flex flex-wrap'>
            <div className='lg:w-1/2 sm:w-full grow sm:p-1.5 '>
              <Image
                src="/img/Build-idias-Idealy.webp"
                alt='Desarrollo a la medida'
                width={600}
                height={400}
                className='w-full shadow-md rounded-[3rem] '
              />
            </div>
        ...
        <div className='w-full mb-15'>
          <div className='w-3/4 m-auto flex flex-wrap-reverse '>
            ...
            <div className='lg:w-1/2  sm:w-full grow'>
              <Image
                src="/img/seo-idias-Idealy.webp"
                alt='Desarrollo a la medida'
                width={600}
                height={300}
                className='w-100% h-auto rounded-[3rem] shadow-md'
              />
            </div>
        ...
        <div className='w-full bg-primary pt-10 pb-10'>
          <div className='w-3/4 m-auto flex flex-wrap'>
            ...
            <div className='lg:w-2/3 pl-1.5 p-3 sm:w-full grow'>
